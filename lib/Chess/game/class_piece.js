class Piece {
	...
	constructor(name,atk,hp,cx,cy,player,mp,expValue,image = this.constructor.img) { //On ne créera jamais d'instances de cette classe directement : ce sont les classes
