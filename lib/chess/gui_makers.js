			...
			for (let j = 0; j < joueur[i].prePiece.length; j++){
				...
				if (currentPre.Piece.constructor.name == "Array"){
					...
					butno.setSelectedPiece = function(id){
						...
						this.img = (currentPiece.img) ? ((currentPiece.img.__proto__.name == "Piece") ? img.piece[this.color][currentPiece.img] : currentPiece.img) : img.piece[this.color][currentPiece]
					}
				}else{
