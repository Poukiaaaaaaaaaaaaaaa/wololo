...
function Event_(name = "Event"){
	...
	eventList.handlerProto = { //on définit ici des props à ajouter au prototype de chaque fonction ajoutée à l'event
		enabled : true,
	...
	eventList.add = function(fct){
		...
		fct.event = eventList
		Object.assign(fct.__proto__, this.handlerProto) //ajout de handlerProto au prototype de la fonction
		
		this.push(fct/*.bind(fct)*/)
	}
